...
public class ExampleGUI : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        {
            Debug.Log("App Identifier "+Application.identifier);
            
            if (!string.Equals(txtManualLaunch, "SDK Launched", StringComparison.OrdinalIgnoreCase))
            {
                
                AdjustConfig adjustConfig = new AdjustConfig("62d1bi1c05fk", AdjustEnvironment.Sandbox);
                ...
                adjustConfig.setAppSecret(1, 551571666, 1432351753, 767562477, 477043169);
