    ...
    public class AdjustAttributionAdapter : IAttributionWithInitializationCallback
    {
        ...
        public void Initialize(string appSubversion, Action onInitialized)
        {
            try
            {
                ...
                if (platformAdjustConfig.SDKSignatureEnabled)
                {
                    adjustConfig.setAppSecret(platformAdjustConfig.SecretId,
                        platformAdjustConfig.SecretInfo1,
                        platformAdjustConfig.SecretInfo2,
                        platformAdjustConfig.SecretInfo3,
                        platformAdjustConfig.SecretInfo4);
                }
